...
class __TwigTemplate_cbb0853bf5142501bf167f89024a8fbd extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/var/www/docker_sf/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}

...
return [
    ...
    'plat_show' => [['id'], ['_controller' => 'App\\Controller\\PlatController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/plat']], [], [], []],
    'plat_edit' => [['id'], ['_controller' => 'App\\Controller\\PlatController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/plat']], [], [], []],
    'plat_delete' => [['id'], ['_controller' => 'App\\Controller\\PlatController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/plat']], [], [], []],
